...
void WorldRenderer::loadShaders()
{
  ...
  etna::create_program(
    "perlin_shader",
    {IMGUI_RENDERER_SHADERS_ROOT "quad.vert.spv",
     IMGUI_RENDERER_SHADERS_ROOT "perlin.frag.spv"}
  );

  etna::create_program(
    "terrain_shader",
    {IMGUI_RENDERER_SHADERS_ROOT "terrain.vert.spv",
     IMGUI_RENDERER_SHADERS_ROOT "terrain.tesc.spv",
     IMGUI_RENDERER_SHADERS_ROOT "terrain.tese.spv",
  ...
  etna::create_program(
    ...
    {IMGUI_RENDERER_SHADERS_ROOT "distribution.comp.spv"}
  );

    etna::create_program(
    "histogram_compute",
    {IMGUI_RENDERER_SHADERS_ROOT "histogram.comp.spv"}
  );

  etna::create_program(
    "postprocess_shader",
    {IMGUI_RENDERER_SHADERS_ROOT "quad.vert.spv",
     IMGUI_RENDERER_SHADERS_ROOT "postprocess.frag.spv"}
  );

  etna::create_program(
    "deferred_shader",
    {IMGUI_RENDERER_SHADERS_ROOT "deferred.vert.spv",
     IMGUI_RENDERER_SHADERS_ROOT "deferred.frag.spv"}
  );

  etna::create_program(
    "skybox_shader",
    {IMGUI_RENDERER_SHADERS_ROOT "skybox.vert.spv",
     IMGUI_RENDERER_SHADERS_ROOT "skybox.frag.spv"}
  );

  etna::create_program(
    "sphere_deferred_shader",
    {IMGUI_RENDERER_SHADERS_ROOT "sphere.vert.spv",
     IMGUI_RENDERER_SHADERS_ROOT "sphere_deferred.frag.spv"}
  );

  etna::create_program(
    "sphere_shader",
    {IMGUI_RENDERER_SHADERS_ROOT "sphere.vert.spv",
     IMGUI_RENDERER_SHADERS_ROOT "sphere.frag.spv"}
  );
