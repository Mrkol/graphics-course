...
private:
  ...
  std::filesystem::path scenePath;  // Path to last scene loaded, for hot reload.
  std::filesystem::path bakedScenePath;  // Path to last scene loaded, for hot reload.
  bool needToReload = false;  // If true, the scene from scenePath will be reloaded.
};
