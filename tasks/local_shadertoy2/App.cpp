...
namespace
{
const auto kTextureName = "texture";
const auto kShaderName = "local_shadertoy2";
  ...
  , useVsync{true}
{
...

  {
    ...
    grafImage =
      etna::create_image_from_bytes(info, etna::get_context().createOneShotCmdMgr()->start(), file);
  ...
  if (nextSwapchainImage)
  {
    ...
    ETNA_CHECK_VK_RESULT(currentCmdBuf.begin(vk::CommandBufferBeginInfo{}));
    {
...

      {
        ...
        const auto info = etna::get_shader_program(kShaderName);
        ...
        const auto set = etna::create_descriptor_set(
          ...
          {etna::Binding{
           ...
           etna::Binding{
             1, grafImage.genBinding(sampler.get(), vk::ImageLayout::eShaderReadOnlyOptimal)}});
